...
export function UserRegistrationModal({ isOpen, onClose, userIdToEdit, onSuccess }: UserRegistrationModalProps) {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      {/* MUDANÇA 1: Aumentei significativamente a largura máxima (sm:max-w-[900px]) */}
      <DialogContent className="sm:max-w-[900px] sm:rounded-lg overflow-hidden">
        ...
        {isLoadingData ? (
          ...
          <form onSubmit={handleSubmit}>
            {/* MUDANÇA 2: Layout em Grid de 2 Colunas */}
            <div className="grid grid-cols-1 md:grid-cols-12 gap-8 py-6">
              
              {/* --- COLUNA DA ESQUERDA (Dados Principais) - Ocupa 7/12 --- */}
              ...
              {/* --- COLUNA DA DIREITA (Configurações e Acesso) - Ocupa 5/12 --- */}
              {/* MUDANÇA 3: Borda lateral e padding para separar visualmente */}
              <div className="md:col-span-5 space-y-6 md:border-l md:pl-8 border-slate-100">
                  ...
                  <div className="space-y-3 pt-2">
                    ...
                    {/* MUDANÇA 4: Lista de grupos mais alta (h-48) */}
